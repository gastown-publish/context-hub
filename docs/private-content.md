...
Today, you can build local content with `gashub build` and point your config at it. But distributing that content across a team — keeping it in sync, versioned, and accessible to every developer's agent — is a manual process.
...
- **Seamless search** — `gashub search` should cover both public and private content without extra steps.
